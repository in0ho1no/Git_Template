...
rem "---------------------------------------------------"
call :run git config --local commit.template git-setup/COMMIT_TEMPLATE
echo [設定] コミットテンプレート
...
rem "---------------------------------------------------"
call :run git config --local core.hooksPath git-setup/hooks
...
rem "---------------------------------------------------"
call :run git config --local fetch.prune true
echo [設定] fetch.prune
...
rem "---------------------------------------------------"
call :run git config --local pull.ff only
echo [設定] pull.ff
...
rem "---------------------------------------------------"
call :run git config --local merge.ff false
echo [設定] merge.ff
...
rem "---------------------------------------------------"
call :run git config --local core.autocrlf false
...
rem "---------------------------------------------------"
call :run git config --local core.safecrlf warn
...
if exist "%WINMERGE%" (
    ...
    call :run git config --local alias.windiff "difftool -y -d -t WinMerge"
